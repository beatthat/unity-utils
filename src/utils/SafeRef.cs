...
{
	/// <summary>
	/// Using a SafeRef to a Component, in the event that the Component's GameObject is destroyed,
	/// the Component reference is changed to null and the reference is deemed 'invalid'
	/// 
	/// This exists to address the problem of holding references to Unity Component instances,
